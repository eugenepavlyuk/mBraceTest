...
{
    [CardView _addOverlay:leftOverlay withDirection:DirectionLeft];
    [CardView _addOverlay:rightOverlay withDirection:DirectionRight];
    [CardView _addOverlay:upOverlay withDirection:DirectionUp];
    [CardView _addOverlay:downOverlay withDirection:DirectionDown];
}
